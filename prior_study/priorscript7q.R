...
xsamples <- rnorm(nsamples,
                  ...
                  sd=sqrt(
                      extraDistr::rbetapr(nsamples,shape1=1,shape2=2,
...
sd2iqr <- 0.5/qnorm(0.75)
dt <- fread('~/repositories/ledley-jaynes_machine/scripts/ingrid_data_nonangds6.csv')
varinfo <- read.csv('~/repositories/ledley-jaynes_machine/scripts/varinfo.csv',row.names=1)
graphics.off()
