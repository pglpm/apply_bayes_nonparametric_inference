...
%% Last-Updated: 2023-01-16T06:33:10+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{\large Reasoning Foundations of Medical Diagnosis II\\(Personalized prognosis \amp\ treatment using Ledley-Jaynes machines)%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Ledley-Jaynes machine}
