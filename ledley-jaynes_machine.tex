...
%% Last-Updated: 2023-02-05T16:03:05+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\end{equation}
which can be used in different guises, for example \autocites[Compare with the inference rules for sequent calculus, \eg][\chap~1]{huthetal2000_r2004}[\sect~I.2]{prawitz1965}[see also][]{boricic2020}
\begin{equation*}
\textstyle  \frac{\P(A\|H) = x}{\P(\lnot A \|H) = 1-x}
  \qquad
...
\,\p(\di F \|I)
\end{multline}
the integral being over all positive, normalized weight distributions $F(y,x)$ over the variables $y,x$. The term $\p(\di F \|I)$ is a positive measure over such distributions.
