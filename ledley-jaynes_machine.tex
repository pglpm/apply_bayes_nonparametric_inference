...
%% Last-Updated: 2023-02-05T13:54:35+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We must therefore set the probability values of some statements, which can lead us to the probabilities~\eqref{eq:general_prob} through the rules of the probability~\eqref{eq:Prules}.
